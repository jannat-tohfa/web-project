...
?>
  ...
  <body id="home">
          ...
          <div>
            <div class="cont-details">
              <div class="table-content table-responsive cart-table-content m-t-30">
                ...
                <h2 style="padding-bottom: 20px;text-align: center;color: #ac39ac;"><b>Elegant Makeover</b></h2>
                <?php
                $cid = $_GET['aptnumber'];
    ...
    <form class="print" method="post" action="./report/reportGeneration.php?aptnumber=<?php echo $_GET['aptnumber']; ?>">
      <input type="hidden" name="aptnumber" value="<?php echo $_GET['aptnumber']; ?>">
